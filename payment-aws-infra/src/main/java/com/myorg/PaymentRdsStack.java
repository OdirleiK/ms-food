...
public class PaymentRdsStack extends Stack {
    public PaymentRdsStack(final Construct scope, final String id, final Vpc vpc) {
        this(scope, id, null, vpc);
    }

    public PaymentRdsStack(final Construct scope, final String id, final StackProps props, final Vpc vpc) {
        super(scope, id, props);

        CfnParameter senha = CfnParameter.Builder.create (this, "senha")
                .type("String")
                .description("Senha do database order-ms")
                .build();
        ...
        DatabaseInstance database = DatabaseInstance.Builder
                ...
                .instanceIdentifier("food-order-db")
